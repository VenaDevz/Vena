...
import {VenaMiningV4} from "../../contracts/robinhood/VenaMiningV4.sol";
 ...
 */
contract DeployMiningV4 is Script {
    function run() external {
        ...
        VenaMiningV4 mining = new VenaMiningV4(vena, nft, address(loadout), deployer, fundingOp);
